...
public class KosarajuSharirSCC {
    ...
    public static void main(String[] args) {
        ...
        Integer[] scc_sizes = new Integer[M];
        // print results

         for (int i = 0; i < M; i++) {
            //StdOut.print(components[i].size()+": ");
            scc_sizes[i] = components[i].size();
        ...
        Arrays.sort(scc_sizes);
        for(int i = scc_sizes.length-1; i >= scc_sizes.length-5; i--){
            StdOut.print(scc_sizes[i] + ",");
        }
